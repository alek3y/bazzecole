...
I _costi_ vengono calcolati in modo diverso da azinda in azienda in base alla *configurazione di costo* cioè l'insieme delle risorse il cui valore determina il costo. +
...
* Costi di prodotto: divisi in costi di *lavoro diretto* relativi agli operai che producono, costi di *materiali diretti* relativi agli acquisti di materie prime, e *costi indiretti di prduzione* associabili all'attività produttiva nel complesso.
...
*Portafoglio applicativo* è l'insieme delle applicazioni informatiche di un'azineda che si divide in:
