...
== A matter of scale
In some cases desktop and laptops are not powerful enough for some operations, in this situations you may need a *workstation*. Workstation are used for expensive and sophisticated applications. +
The next level are the *mainframes* that are able to handling huge amount of data in a serial way or in a parallel way. +
After the mainframe, there is the *supercomputer* that is bigger, faster and more expensive. Today supercomputer are used for weather maps, earthquake prediction and a lot of scientific operations.
