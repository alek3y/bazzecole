...
A Firenze conosce Capuana da cui si ispira per scrivere romanzi di ambientazione mondana come "Eva". A Milano, invece, scopre gli autori del Naturalismo da qui si sviluppa il suo forte *pessimismo* e la sua *posizione politica reazionaria*, cioè contrario alla rivoluzione.
