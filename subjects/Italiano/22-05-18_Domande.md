...
Le opere principali di Montale sono "Ossi di seppia", "Le occasioni", "La bufera e altro" e "Satura" infine ci sono anche le sue ultime poesie di carattere satirico.

### 2. Tematiche presenti nella sua poesia

I temi fondamentali che affronta montale nelle sue opere sono: 
- **Il male di vivere**, in cui è convinto che la vita è colma di male e negatività e lui vuole descriverla nelle sue opere.
...
Montale utilizza un linguaggio scarno, duro e che contiene solo l'essenziale. \
Rifiuta la poetica che andava di moda (quella di D'Annunzio), preferendo un linguaggio più comune, talvolta anche dialettale. \
Utilizza la tecnica del **Correlativo oggettivo**, cioè utilizza degli oggetti per suscitare delle emozioni nel lettore. \
Nella sua ultima fase utilizza un tono più comico. \
Montale nonstante rappresenti la realtà quotidiana non appartiene prettamente alla corrente del Realismo: lui utilizza si degli oggetti quotidiani ma per rappresentare altro (emozioni, idee, ricordi), legando così il Realismo (prosa, espressione senza schemi metrici. L'opposto della poesia) al simbolismo (poesia).

### 4. Ossi di seppia (raccolta di poesie)

Ossi di seppia è un'opera del 1925, prende questo titolo perchè deriva dal paragone fra gli ossi di seppia che vengono levigati dalle onde del mare e il poeta che leviga le sue poesie fino a ridurle all'osso. Infatti le sue poesie in questa raccolta sono scarne e ridotte all'essenziale. \
L'opera è ambientata in Liguria e le poesie in questa raccolta devono rappresentare la realtà che, secondo Montale, è la negatività del mondo che sembra essere irrecuperabile. \
Alcune poesia presenti in questa opera sono "I limoni", "Meriggiare pallido e assorto" e "Spesso il male di vivere ho incontrato".

## Ermetismo

### 1. Cosa significa ermetismo?

Il termine Ermetismo fu utilizzato la prima volta dal critico Francesco Flora nel 1936 in un suo saggio letterario, definendolo come un insieme di esperienze poetiche caratterizzate dall'oscurità, cioè che erano difficili da comprendere e interpretare rispetto alle poesie del 1800/inizio 1900. \
Venne usato questo termine in riferimento a Ermes, dio greco delle scienze occulte e misteriose.

### 2. Quale periodo storico indica?

Questo movimento influenza la poesia degli anni 30. Francesco Flora raggruppava nell'Ermetismo: la raccolta di Ungaretti "Il porto sepolto" e alcune poesie di Montale tra cui "Ossi di seppia". \
...
Inoltre la poesia è estremamente breve, rappresenta infatti un momento improvviso che vive il poeta, rendendo così la poesia all'essenziale e di difficile comprensione.

## Pirandello

### 1. Opere di narrativa di Pirandello

Tra le opere di narrativa più conosciute di Pirandello troviamo sia delle novelle come "novelle per un anno" e "una giornata", ma anche dei romanzi come "L'esclusa", "Il fu Mattia Pascal" e "Uno, nessuno e centomila".

### 2. Opere di teatro di Pirandello

La produzione teatrale di pirandello conta circa 40 drammi, raggruppati nella raccolta "Maschere nude". \
Le sue opere teatrali portano molta rivoluzione: proponeva drammi borghesi realistici, i personaggi avevano una personalità problematica e viene molto utilizzato lo strumento dell'umorismo.

### 3. Che idea ha Pirandello della realtà

Secondo Pirandello non esite una realtà comune per tutti. Lui la definisce "relativismo conoscitivo" e intende che non esiste una verità oggettiva e valida per tutti, per cui la realtà è un punto di vista che dipende dalla persona che osserva. \
Per dare questa definizione Pirandello si ispirò dalla situazione di sua moglie: la moglie, che aveva una malattia mentale, non vedeva la realtà come la vedeva lui.
...
Dice infatti che lui è **uno** per il modo in cui si vede, le immagini che gli altri hanno di lui sono **centomila** e dato che non è possibile dare un'identità univoca è anche **nessuno** (da questo deriva il nome dell'opera). \
...
Pirandello scrisse un saggio nel 1908 chiamato "L'umorismo" in cui fa una differenza tra comicità e umorismo per poter capire la sua poetica: \
con comicità intende un fatto che è contrario a come ce lo aspettiamo e che ci porta alla risata, mentre definisce umorismo come una riflessione in cui vengono svelate delle realtà dolorose che si nascondono dietro al fatto comico. \
...
L'incomunicabilità, cioè il racchiudersi in se stesso e isolarsi dagli altri deriva da:
- Quelle che lui definisce trappole sociali, come la famiglia e il lavoro.
- Dal suo **concetto di maschera**, per cui ogni uomo per avere un ruolo nella società deve indossare una maschera e quindi interpretare un ruolo, solo attraverso la follia è possibile togliere questa maschera.
- Infine dal fatto che ognuno vede in mondo secondo il proprio punto di vista.

### 7. Che tipo di lingua usa?

Pirandello utilizza un linguaggio privo di retorica favorendo una lingua comprensibile e non ricercata (infatti molte sue opere vennero tradotte all'estero).
Delle volte sono presenti dei termini dialettali, stranieri o derivati da un linguaggio più tecnico.
...
Nacque nel 1901 e nella sua vita è possible individuare due principali periodi di importanza: \
...
- Nel secondo periodo decide di dedicarsi più a tematiche sociali e storiche. Proprio perchè ritiene che la seconda guerra mondiale sia stata una tragedia cerca di impegnarsi nelle sue poesie per recuperare le buone tradizioni dell'uomo, utilizzando una poetica più vicina a quella del 1800 allontanandosi così dalla corrente ermetica.

## Pavese

### 1. Le opere

le opere più famose di Pavese sono: \
**Lavorare stanca**, una raccolta di poesie che raccontano brevi storie in cui i personaggi sembrano quasi rappresentare la vita del poeta. I temi predominanti sono la solitudine, l'amore e le delusioni in amore, il nome deriva proprio dal fatto che ritiene che la vita senza contatti umani e relazioni d'amore sia un lavoro che stanca.
